    ...
    <div class="media post">
        ...
        <div class="media-body">
            ...
            <form v-if="editing">
                ...
                <button type="button" v-on:click="update" class="btn btn-primary btn-sm" :disabled="isInvalid">Update</button>
            ...
            <div v-else>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="ml-auto">
                            @can ('update', $answer)
                            <a @click.prevent="edit" class="btn btn-sm btn-outline-info">Edit</a> @endcan @can ('delete', $answer)
